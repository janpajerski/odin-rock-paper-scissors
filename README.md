...
The Rock Paper Scissors project from The Odin Project Foundations Course. This is the firs JavaScript project built from scratch. The first part of the project has no GUI. The game will be played entirely from the console. 

## Assignment
The instructions below are from https://www.theodinproject.com/lessons/foundations-rock-paper-scissors.
